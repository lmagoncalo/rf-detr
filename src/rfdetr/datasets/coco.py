...
class CocoDetection(torchvision.datasets.CocoDetection):
    ...
    def __init__(
        ...
        if remap_category_ids:
            ...
            self.cat2label = None
            self.label2cat = None
        self.prepare = ConvertCoco(include_masks=include_masks, cat2label=self.cat2label, include_keypoints=include_keypoints, num_keypoints=num_keypoints)
...
class ConvertCoco(object):
    ...
    def __init__(self, include_masks: bool = False, cat2label: Optional[Dict[int, int]] = None, include_keypoints:bool = False, num_keypoints:int = 17) -> None:
        self.include_masks = include_masks
